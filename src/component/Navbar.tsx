...
export const Navbar = () => {
  ...
  return (
    <header className="flex items-center justify-between sm:px-16 px-5 pt-6 animate-fade animate-once animate-duration-[2000ms] animate-ease-out animate-delay-[5210ms]">
